	...
	return (
		<div className="w-screen h-screen flex flex-col items-center bg-background">
			<div className="w-full h-3/5 flex flex-col justify-center items-center">
				<img src="back.gif" className="w-2/5"/>
			...
			<div className="w-full h-2/5 flex justify-center items-center">
				<button
					...
					onClick={()=>{
						window.location.href = "https://dial.to/?action=solana-action:https://scramble.nixblack.site/api/actions/create-roulette&cluster=devnet"
					}}
				>
					Create a challenge
				</button>
