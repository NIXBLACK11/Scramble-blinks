...
import { createTransaction } from "@/app/utils/transaction";
  ...
  export const GET = async (req: Request) => {
    try {
      logger.info("GET request received for Scramble");
      ...
      const payload: ActionGetResponse = {
        title: "Test Your Word Scramble Skills! 🔤",
        icon: new URL("/back.gif", requestUrl.origin).toString(),
        type: "action",
        description: `Player 1 sets the wager, completes the scramble challenge, and sets a Score. Share the game link with Player 2 to see if they can beat it. May the best typer win!`,
